...
public class UberSignUpTest {
	public class UberSignUp {
	    ...
	    public void test02_signUp()throws Exception{
	    	...
	    	email = mySheet.getEmail();
	    	firstname = mySheet.getFirstname();
	    	lastname = mySheet.getLastname();
	    	phonenumber = mySheet.getPhoneNumber();
	    	password = mySheet.getPassword();
